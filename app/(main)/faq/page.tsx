...
function HandshakeIcon(props: React.ComponentProps<typeof Handshake>) {
  return <Users {...props} />;
}
...
export default function FAQPage() {
  ...
  const filteredSections = useMemo(() => {
    ...
    return faqSections
      .filter(
        (section) =>
          activeSection === "all" || section.number === activeSection
      )
      .map((section) => ({
        ...section,
        faqs: query
          ? section.faqs.filter((faq) => {
              return (
                ...
                faq.help?.toLowerCase().includes(query) ||
                faq.bullets?.some((item) =>
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="container mx-auto">
        <div className="max-w-4xl mx-auto text-center md:py-sections py-middel">
          ...
          <p className="mt-6 text-muted-foreground leading-7">
            Buying, selling or owning property in Koh Phangan can raise many
            questions — particularly for international buyers.
          </p>

          <p className="mt-4 text-muted-foreground leading-7">
            We have put together practical answers to the questions we hear
            most often.
          </p>

          <div className="mt-7 rounded-2xl border border-primary/10 bg-primary/5 p-5 md:p-6 text-left">
            <div className="flex gap-4">
              <ShieldCheck className="w-6 h-6 text-primary shrink-0 mt-0.5" />

              <p className="text-sm md:text-base text-muted-foreground leading-6">
                Our role is not to replace your lawyer, accountant, architect
                or other specialist. We help you understand the property,
                identify the important questions and coordinate the right
                professionals when specialist advice is required.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Search + Stats */}
      <section className="container mx-auto pb-middel md:pb-sections">
        <div className="grid lg:grid-cols-[1fr_auto] gap-5 items-center">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-14 rounded-xl border border-border bg-background pl-12 pr-5 outline-none transition-all focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>

          <div className="flex items-center justify-center gap-3 rounded-xl bg-muted px-5 py-3 h-14">
      ...
      {/* Category Navigation */}
      <section className="container mx-auto pb-middel">
      ...
      {/* FAQ Sections */}
      <section className="bg-muted/40 md:py-sections py-middel">
        <div className="container mx-auto space-y-14">
          {filteredSections.length > 0 ? (
            filteredSections.map((section) => {
              ...
              return (
                <div key={section.number} id={`faq-${section.number}`}>
                  {/* Section Heading */}
                      ...
                      return (
                        ...
                        >
                          <button
                            ...
                            className="w-full flex items-center justify-between gap-5 text-left px-5 md:px-6 py-5"
                            aria-expanded={isOpen}
                          >
                            <div className="flex items-start gap-4">
                              <span className="hidden sm:flex shrink-0 w-8 h-8 rounded-full bg-primary/10 items-center justify-center text-primary">
                          ...
                          >
                            <div className="overflow-hidden">
                              <div className="px-5 md:px-6 pb-6 sm:pl-[68px]">
                                ...
                                {faq.help && (
                                  <div className="mt-5 rounded-xl bg-primary/5 border border-primary/10 p-4 md:p-5">
                                    <div className="flex gap-3">
                                      <CheckCircle className="w-5 h-5 text-primary shrink-0 mt-0.5" />

                                      <div>
                                        <p className="font-semibold text-sm">
                                          How Tropical Roots Helps
                                        </p>
      ...
      <section className="container mx-auto md:py-sections py-middel">
        <div className="rounded-2xl border border-border/70 bg-background overflow-hidden">
          <div className="grid lg:grid-cols-[0.8fr_1.2fr]">
            <div className="bg-primary text-primary-foreground p-7 md:p-10 flex flex-col justify-center">
              <span className="text-white/70 uppercase tracking-[0.2em] text-sm">
              ...
              <p className="text-white/80 leading-7 mt-5">
                We will never promise a sale price or timeline simply to win
                your listing.
              </p>
            </div>
            ...
            <div className="p-7 md:p-10">
              <p className="text-muted-foreground leading-7">
                We promise to present your property professionally, market it
                properly, communicate clearly and work efficiently.
              </p>
      ...
      {/* Philosophy */}
      <section className="bg-primary md:py-sections py-middel">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white/80 text-lg md:text-xl leading-8 mt-5">
              It is a relationship that can continue for years.
            </p>

            <p className="text-white/70 leading-7 mt-6 max-w-2xl mx-auto">
              You may first contact us because you want to buy a villa. Later,
              you may need a tenant, maintenance, renovation, construction,
              property management or a future sale.
            </p>

            <p className="text-white/90 leading-7 mt-5 max-w-2xl mx-auto font-medium">
              We want Tropical Roots Realty to be the company you can continue
              to call throughout that journey.
            </p>
      ...
      <section className="container mx-auto md:py-sections py-middel">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground leading-7 mt-4">
            Every property is different. If you have a question about buying,
            selling, renting, maintaining or developing property in Koh
            Phangan, contact us and we&apos;ll help you find the right answer.
          </p>

          <Link
            href="/contact"
            className="inline-flex items-center gap-2 mt-7 bg-primary text-primary-foreground px-7 py-3.5 rounded-lg font-semibold transition-all hover:gap-3 hover:opacity-90"
          >
            Ask Us a Question
      ...
      {/* Disclaimer */}
      <section className="container mx-auto pb-middel md:pb-sections">
        <div className="rounded-2xl border border-border/70 bg-muted/30 p-5 md:p-7">
          <div className="flex gap-4">
            <ShieldCheck className="w-6 h-6 text-primary shrink-0 mt-0.5" />
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-6 mt-2">
                This FAQ is for general information only and is not legal, tax,
                financial, architectural or engineering advice. Thai laws,
                regulations, taxes and local requirements can change.
                Property-specific professional advice should be obtained before
